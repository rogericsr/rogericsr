...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=00FF41&center=true&vCenter=true&width=600&lines=Systems+Engineering+Student;Red+Team+%7C+Penetration+Testing+Learner;Breaking+things+to+understand+them;The+quieter+you+become%2C+the+more+you+hear)](https://git.io/typing-svg)
...
class Kinsman:
    ...
    goal        = "Junior Red Team Operator"
    motto       = "Hack to learn, learn to hack"

    def current_mission(self):
        return [
            "📚 Structured Red Team learning roadmap (20 weeks)",
            "🔐 Mastering network & web exploitation fundamentals",
            "🏴‍☠️ Grinding OverTheWire, TryHackMe & picoCTF",
            "🎯 Target certifications: eJPT → PNPT → OSCP"
        ]
```
